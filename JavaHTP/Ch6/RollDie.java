...
public class RollDie {
	public static void main(String[] args) {
		...
		int frequency1 = 0; // count 1s rolled
		int frequency2 = 0; // count 2s rolled
		int frequency3 = 0; // count 3s rolled
		int frequency4 = 0; // count 4s rolled
		int frequency5 = 0; // count 5s rolled
		int frequency6 = 0; // count 6s rolled
